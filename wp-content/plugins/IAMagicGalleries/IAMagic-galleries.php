...
if (file_exists(IAMG_PATH . '/_test/defs.php')) {
    ...
    $v = json_decode(file_get_contents(IAMG_PATH.'/version.json'), true)["version"];
    define("IAMG_VERSION", $v);
} else {
    /**TESTING/*/
    define("IAMG_VERSION", '{{ VERSION }}');
...
//This must be after IAMGComDispatcher.php
if (is_admin()) {
