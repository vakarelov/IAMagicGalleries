...
Tested up to: {{ WPTESTED }}
Stable tag: {{ VERSION }}
License: GPLv2 or later
License URI: https://www.gnu.org/licenses/gpl-2.0.html
Requires PHP: {{ PHP_REQUIRE }}
...
This is used to load the YouTube player API when a YouTube video is added to the gallery.
[Terms of Service](https://developers.google.com/youtube/terms/api-services-terms-of-service)
* Vimeo
https://vimeo.com/api/oembed.json
This is used to load the Vimeo player API when a Vimeo video is added to the gallery.
...
This is used to register the plugin with the SAS, to obtain IA Presenter and other interactive resources, and to generate the galleries.
...
- Efficiency optimizations:
    - Better compression of data, and no need of processing at the WP server side.
    - LocalStage caching of app on the client speeds up loading times for users.
= 1.1.0 =
